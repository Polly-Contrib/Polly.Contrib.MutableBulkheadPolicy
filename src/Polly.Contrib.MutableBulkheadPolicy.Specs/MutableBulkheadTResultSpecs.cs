...
{
    public class MutableBulkheadTResultSpecs : MutableBulkheadSpecsHelper
    {
        public MutableBulkheadTResultSpecs(ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
            ...
            bool cancelExecuting, int updateMaxParalelizationDelta, int updateQueuingActionsDelta, string scenario)
        {
            ...
            for (int i = 0; i < totalActions; i++) { tasks[i] = actions[i].ExecuteOnBulkhead(MutableBulkhead); }
