...
{
    public class MutableBulkheadSpecs : MutableBulkheadSpecsHelper
    {
        public MutableBulkheadSpecs(ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
        ...
        public void Should_call_onBulkheadRejected_with_passed_context()
        {
            ...
            MutableBulkheadPolicy MutableBulkhead = MutableBulkheadPolicy
                .Create(1, onRejected);
            ...
            using (CancellationTokenSource cancellationSource = new CancellationTokenSource())
            {
                ...
                MutableBulkhead.Invoking(b => b.Execute(ctx => { }, contextPassedToExecute)).ShouldThrow<BulkheadRejectedException>();
            ...
            bool cancelExecuting, int updateMaxParalelizationDelta, int updateQueuingActionsDelta, string scenario)
        {
            ...
            MutableBulkheadPolicy bulkhead = MutableBulkheadPolicy
                .Create(maxParallelization, maxQueuingActions);
