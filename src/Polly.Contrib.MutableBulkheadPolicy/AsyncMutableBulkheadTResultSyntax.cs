...
namespace Polly.Contrib.MutableBulkheadPolicy
{
    ...
    {
        /// <summary>
        /// <para>Builds a mutable bulkhead isolation <see cref="AsyncPolicy{TResult}"/>, which limits the maximum concurrency of actions executed through the policy.  Imposing a maximum concurrency limits the potential of governed actions, when faulting, to bring down the system.</para>
        ...
        public static AsyncMutableBulkheadPolicy<TResult> Create<TResult>(int maxParallelization)
        {
        ...
        /// <returns>The policy instance.</returns>
        public static AsyncMutableBulkheadPolicy<TResult> Create<TResult>(int maxParallelization, Func<Context, Task> onBulkheadRejectedAsync)
            => Create<TResult>(maxParallelization, 0, onBulkheadRejectedAsync);

        /// <summary>
        /// Builds a mutable bulkhead isolation <see cref="AsyncPolicy{TResult}" />, which limits the maximum concurrency of actions executed through the policy.  Imposing a maximum concurrency limits the potential of governed actions, when faulting, to bring down the system.
        ...
        /// <exception cref="System.ArgumentNullException">onBulkheadRejectedAsync</exception>
        public static AsyncMutableBulkheadPolicy<TResult> Create<TResult>(int maxParallelization, int maxQueuingActions)
        {
            Func<Context, Task> doNothingAsync = _ => TaskHelper.EmptyTask;
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">maxQueuingActions;Value must be greater than or equal to zero.</exception>
        /// <exception cref="System.ArgumentNullException">onBulkheadRejectedAsync</exception>
        public static AsyncMutableBulkheadPolicy<TResult> Create<TResult>(int maxParallelization, int maxQueuingActions, Func<Context, Task> onBulkheadRejectedAsync)
        {
            ...
            return new AsyncMutableBulkheadPolicy<TResult>(
                maxParallelization,
                maxQueuingActions,
